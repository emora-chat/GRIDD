...
PREVAR = 'prevar'               # metagraph precondition variable link
PRE = 'pre'                     # metagraph precondition link
POST = 'post'                   # metagraph postcondition link
POSTVAR = 'postvar'             # metagraph postcondition variable link
REF = 'ref'                     # metagraph reference link
REFVAR = 'refvar'               # metagraph reference variable link